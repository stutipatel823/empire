  ...
  return (
    <header>
      <nav className="sm:w-screen flex justify-between items-center p-5 font-bold">
        <Link to="/home" className="text-2xl flex items-center space-x-2 text-primary-dark font-serif">
          <span>𝓔𝓶𝓹𝓲𝓻𝓮</span>
        </Link>
        ...
        <div className="hidden sm:flex space-x-6 items-center">
          ...
          <div className="relative group">
            ...
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <Link to="/profile" className="block px-4 py-2 text-primary-dark hover:bg-gray-100">Profile</Link>
              <Link to="/" className="block px-4 py-2 text-primary-dark hover:bg-gray-100">Logout</Link>
            </div>
          </div>
        </div>
        ...
        {isMobileMenuOpen && (
          <div className="fixed inset-0 bg-primary-light z-50 flex flex-col items-center justify-center  sm:hidden">
            ...
            <div className="flex flex-col items-start space-y-4">
                ...
                <Link to="/" className="px-10 py-2 border-t border-secondary-gray text-primary-dark hover:text-secondary-accent text-2xl" onClick={toggleMobileMenu}>
